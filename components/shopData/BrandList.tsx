...
interface Props {
  ...
  setSelectedBrand: React.Dispatch<React.SetStateAction<string | null>>; /*A function that updates a (string | null) state,
        ...
        {brands?.map((brand) => (
          ...
          >
            ...
            <Label
              ...
              className={`${selectedBrand === brand?.slug?.current ? "font-semibold text-[#063c28]" : "font-normal"}`}
            >
              {brand?.title}
            </Label>
          </div>
